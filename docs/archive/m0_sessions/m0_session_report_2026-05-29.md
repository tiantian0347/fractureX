...
> 范围：[plan_operator_learning.md](../../operator_learning/plan_operator_learning.md) §M0 硬性交付物 2 的 σ-段闭环。
...
[m0_interpolation_error.md](../../operator_learning/m0_interpolation_error.md) 也只是 v0.1 骨架，§4 全部留白。
...
原本 m0 计划把"插值误差报告"作为一刀，但盘点 [m0_interpolation_error.md](../../operator_learning/m0_interpolation_error.md)
...
[m0_interpolation_error.md](../../operator_learning/m0_interpolation_error.md) §2.2 的数学描述是"投影回节点
...
[m0_interpolation_error.md](../../operator_learning/m0_interpolation_error.md) §3.1 的 h0/h1/h2/h3 四档是占位。
...
### 2.5 [docs/m0_interpolation_error.md](../../operator_learning/m0_interpolation_error.md) v0.2
...
[plan_operator_learning.md](../../operator_learning/plan_operator_learning.md) §3.3 与 m0_interpolation_error.md
...
[plan_operator_learning.md §9.1](../../operator_learning/plan_operator_learning.md#91-论文的三条核心创新)
...
5. **§5.2 默认选择写定**：根据 §4.2 实测决定 𝓗 默认 𝓘₁ 或 𝓘₂；同步更新
   schema §3.5 注释 + [m0_interpolation_error.md](../../operator_learning/m0_interpolation_error.md) §5。
...
| [docs/m0_interpolation_error.md](../../operator_learning/m0_interpolation_error.md) | 修改 v0.2 | §4.1 表实数填充 / §4.3 图入库 / §5.1 σ 默认结论；§4.2 𝓗 段标 D-B deferred |
...
- recorder.py（D-B 范围）；
- schema 文档 [SURROGATE_DATA_SCHEMA.md](../../operator_learning/SURROGATE_DATA_SCHEMA.md)（无字段变更，§3.5 注释更新留给 D-B）；
