...
- [x] 写实验跟踪表 `docs/experiment_matrix.md`
...
**思路**：扫描 `results/phasefield/*/*/epsg_*/`，对每个 run 抓 `summary.json` 的 `case`、`mode`、`gdof`、`wall_time`、状态，自动生成一份 Markdown 表，覆盖 `experiment_matrix.md` 里"状态"一列。
...
- [ ] `experiment_matrix.md` 状态列同步到 P1 末尾真实状态
